...
![Voxels under a directed network](../docs/images/combined/01_combined_superior.png)
...
|---|---|
| ![network only](../docs/images/combined/03_network_only.png) | ![combined](../docs/images/combined/01_combined_superior.png) |
...
![Combined, three views](../docs/images/combined/02_combined_multiview.png)
