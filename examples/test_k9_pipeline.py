"""
Test Script for Enhanced Brain Modularity Pipeline
==================================================
Process k5-k15 data with all fixes including state mapping.

This script demonstrates how to use the HarrisLabPlotting package
to run the enhanced visualization pipeline.
"""
...
def process_all_k_values():
    ...
    # Base paths - UPDATE THESE TO YOUR PATHS
    ...
    print("Using HarrisLabPlotting Package")
    print("="*80)
    print("\nFeatures:")
