...
![Voxel maps on a glass brain](../images/voxel/01_quickstart_superior.png)
...
![Thresholds](../images/voxel/07_thresholds.png)
...
![Background](../images/voxel/05_background.png)
...
![Two files vs one signed](../images/voxel/06_two_files_vs_signed.png)
...
![Smoothing](../images/voxel/03_smoothing.png)
...
![Level correction](../images/voxel/04_level_correction.png)
...
![Opacity](../images/voxel/ref_opacity.png)
...
![Surfaces](../images/voxel/ref_surfaces.png)

### `--ghost-opacity` / `--glass` — the brain shell

![Ghost](../images/voxel/ref_ghost.png)
...
![Multi-view](../images/voxel/02_multiview.png)

![Camera presets](../images/voxel/ref_views.png)
...
* [`ALIGNMENT_CHECKS.md`](../how_to/check_atlas_mesh_alignment.md) — pre-flight checks for a new
  atlas/mesh pair
* [`COMBINED_VOXEL_NETWORK.md`](combined_voxel_network.md) — voxel maps and a
  connectivity network in one figure
* [`MESH_CREATION_GUIDE.md`](../data_preparation/nifti_to_mesh.md) — turning a NIfTI into a
  surface
