...
![Basic 28-ROI connectivity network, superior view](../_static/images/cli_tutorial/04_basic_28roi.png)
...
![114-ROI network with hover metrics](../_static/images/cli_tutorial/05_114roi_metrics.png)
...
![Fixed edge width: every line is 2 px](../_static/images/cli_tutorial/07_fixed_width.png)
...
![PNG export — superior view, 114 ROIs](../_static/images/cli_tutorial/08a_png.png)
...
![SVG export preview — oblique view](../_static/images/cli_tutorial/08b_svg.png)
...
![PDF export preview — anterior view](../_static/images/cli_tutorial/08c_pdf.png)
...
![Clean PNG: no title, no legend](../_static/images/cli_tutorial/09a_clean.png)
...
![Title kept, legend stripped](../_static/images/cli_tutorial/09b_title_only.png)
...
![Clean PDF preview — left lateral view](../_static/images/cli_tutorial/09c_clean_pdf.png)
...
![Node visibility toggling](../_static/images/cli_tutorial/10_node_visibility.png)
...
![Module-colored nodes](../_static/images/cli_tutorial/11_module_colors.png)
...
![Modularity plot with Q and Z scores in the title](../_static/images/cli_tutorial/12a_q_z.png)
...
![Module-colored edges, anterior view](../_static/images/cli_tutorial/12b_module_edges.png)
...
![Sign-colored edges with module-colored nodes](../_static/images/cli_tutorial/12c_sign_edges.png)
...
![Per-node sizes from CSV (PC-scaled)](../_static/images/cli_tutorial/13_vector_sizes.png)
...
![28-ROI network with every ROI labelled (default)](../_static/images/cli_tutorial/14a_labels_default.png)
...
![28-ROI network with no persistent labels](../_static/images/cli_tutorial/14b_labels_off.png)
...
![28-ROI network with only the six hub ROIs labelled](../_static/images/cli_tutorial/14c_labels_hubs.png)
